...
if __name__ == "__main__":
    # python FID.py --path /home/experiment_t2i/VRD_14relation_re12_test_imageid/
    ...
    args.imagepath = os.path.join(args.path, 'generated_images')
    args.jsonpath = os.path.join(args.path, filename+'.json')
    fid_value = calculate_fid_given_paths(args.imagepath, args.jsonpath, args.batch_size, args.gpu, args.dims).item()
